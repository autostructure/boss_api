var testData = {"rows": [
        ...
        , {"section": "AD", "sectionDescription": "Administration", "name": "Unger, Adam", "ppLeft": 10, "regPayPerPP": 8080.00, "regPayToDate": 0, "overtimeToDate": 0, "regPayForecast": 10000.00, "totalFYForecast": 10000.00}
        ...
        , {"section": "gd", "sectionDescription": "Administration", "name": "Mahar, Fay", "ppLeft": 10, "regPayPerPP": 18080.00, "regPayToDate": 0, "overtimeToDate": 0, "regPayForecast": 10000.00, "totalFYForecast": 10000.00}
...
$(document).ready(function () {
    ...
    $.ajax({
        type: 'GET',
        url: api + '/boss/payrollDetails/json',
        success: function (json) {
            console.log(json);
