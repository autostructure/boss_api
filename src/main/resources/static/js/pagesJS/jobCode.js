...
$(document).ready(function() {
  try {
    ...
    $('#jobCodes thead tr:nth-child(1) th:nth-child(2)').each(function() {
      $(this).html(
        '<label class="headLabel" for="unitCode">Unit Code</label><input type="text" id="unitCode" class="headSearch" placeholder="Search Unit Code" />'
      );
    });
    $('#jobCodes thead tr:nth-child(1) th:nth-child(3)').each(function() {
      $(this).html(
        '<label class="headLabel" for="jcode">Job Code</label><input type="text" id="jcode" class="headSearch" placeholder="Search Job Code" />'
      );
    });
    $('#jobCodes thead tr:nth-child(1) th:nth-child(4)').each(function() {
      $(this).html(
        '<label class="headLabel" for="desc">Description</label><input type="text" id="desc" class="headSearch" placeholder="Search Description" />'
      );
    });
  } catch (e) {
    alert(e);
  ...
  $.ajax({
    type: 'GET',
    url: '/boss/jobCode/?financialYear=' + fy,
