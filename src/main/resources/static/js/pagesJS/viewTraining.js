            ...
            if(supervisor == true)
            {
                ...
                $.ajax({
                    ...
                    success: function(json) {
                        ...
                        //json.email = json.nameCode; //this is a quick fix, need to alter the java
                        emp = json;
                        ...
                        /*CustomFormFunctions.putPartialInfo("/training", id, { 'approvedBy': json }, function () {
                            window.location.reload();
                        });*/
