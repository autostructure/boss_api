$(document).ready(function() {
    ...
    function populateTable(json) {
        var table = $("#EmployeePrintTable").DataTable({
            ...
            'columns': [
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return `
                                <a data-toggle="modal" data-target="#myModal_print" href="#" data-value=` +
                            data.id +
                            ` class="btn btnPrint btn_pers_copy" id="btnPrint">View / Print</a>
        ...
        $("#myModal_print").on("shown.bs.modal",
            function() {
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        ...
                        modal.find(".modal-body #PrimaryPhoneOne").val(json.emergencyContactHomePhone1);
                        modal.find(".modal-body #SecondaryPhoneOne").val(json.emergencyContactCellPhone1);
                        //modal.find(".modal-body #PersonalEmail").val(json.emer);
                        ...
                        modal.find(".modal-body #PrimaryPhoneTwo").val(json.emergencyContactHomePhone2);
                        modal.find(".modal-body #SecondaryPhoneTwo").val(json.emergencyContactCellPhone2);
