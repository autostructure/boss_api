...
$(document).ready(function() {
  ...
  try {
    $('#dateentered, #tdateentered, #vdateentered, #odateentered').datepicker(
      'setDate',
      new Date().toDateString()
    );
    $('#datemod, #tdatemod, #vdatemod, #odatemod').datepicker(
      'setDate',
      new Date().toDateString()
    );
    $('#dateob, #tdateob, #vdateob, #odateob').datepicker(
      'setDate',
  ...
  getbudgetObjectCodeApiCall(
    getBudgetObjectCodeSuccess,
    getBudgetObjectCodeError
  );
  ...
  function getJobCodeSuccess(info) {
    try {
      $.each(info, function(value, key) {
        $('#jobcode, #tjobcode, #vjobcode, #ojobcode').append(
          $('<option />')
            .val(key.id)
            .text(key.jobCode)
            .attr('id', key.id)
  ...
  function getActivityCodeSuccess(info) {
    try {
      $.each(info, function(value, key) {
        $('#actcode, #tactcode, #vactcode, #oactcode').append(
          $('<option />')
            .text(key.name)
            .val(key.code)
        );
  ...
  function getExpenseSuccess(info) {
    try {
      $.each(info, function(value, key) {
        $('#expcode, #texpcode, #vexpcode, #oexpcode').append(
          $('<option />')
            .text(key.id + '-' + key.type)
            .val(key.id)
        );
      });
    } catch (e) {
  ...
  function getEmployeeProfileSuccess(info) {
    try {
      $.each(info, function(value, key) {
        $('#namecode,#tnamecode,#vnamecode,#onamecode').append(
          $('<option />')
            .text(key.nameCode)
            .val(key.id)
        );
  ...
  try {
    ...
    $('#timeTable tr').each(function() {
      var table_exp = $(this)
        .find('#tableExp')
        .html();
      var table_jobcode = $(this)
        .find('#tableJobCode')
        .html();
      var table_hours = $(this)
        .find('#tableHours')
        .html();
      var table_jobCodeDesc = $(this)
        .find('#tableJobCodeDesc')
        .html();
      var table_amount = $(this)
        .find('#tableAmount')
        .html();
      var table_dateVerified = $(this)
        .find('#tableDateVerified')
        .html();
      //debugger;
      try {
    ...
    $.ajax({
      ...
      success: function(key) {
        ...
        if (key.driversLicense != undefined) {
          employeeProfileJSON.driversLicense.expiration = getCorrectDateFormat(
            key.driversLicense.expiration
          );
          employeeProfileJSON.driversLicense.id = parseInt(
        ...
        if (key.emergencyContactCellPhone1 != undefined) {
          employeeProfileJSON.emergencyContactCellPhone1 =
            key.emergencyContactCellPhone1;
        } else {
          employeeProfileJSON.emergencyContactCellPhone1 = '';
        }
        ...
        if (key.emergencyContactCellPhone2 != undefined) {
          employeeProfileJSON.emergencyContactCellPhone2 =
            key.emergencyContactCellPhone2;
        } else {
          employeeProfileJSON.emergencyContactCellPhone2 = '';
        }
        ...
        if (key.emergencyContactFirstName1 != undefined) {
          employeeProfileJSON.emergencyContactFirstName1 =
            key.emergencyContactFirstName1;
        } else {
          employeeProfileJSON.emergencyContactFirstName1 = '';
        }
        ...
        if (key.emergencyContactFirstName2 != undefined) {
          employeeProfileJSON.emergencyContactFirstName2 =
            key.emergencyContactFirstName2;
        } else {
          employeeProfileJSON.emergencyContactFirstName2 = '';
        }
        ...
        if (key.emergencyContactRelationship1 != undefined) {
          employeeProfileJSON.emergencyContactRelationship1 =
            key.emergencyContactRelationship1;
        } else {
        ...
        if (key.emergencyContactRelationship2 != undefined) {
          employeeProfileJSON.emergencyContactRelationship2 =
            key.emergencyContactRelationship2;
        } else {
        ...
        if (key.emergencyContactState1 != undefined) {
          employeeProfileJSON.emergencyContactState1 =
            key.emergencyContactState1;
        } else {
          employeeProfileJSON.emergencyContactState1 = ''; //key.emergencyContactState1;
        }

        if (key.emergencyContactState2 != undefined) {
          employeeProfileJSON.emergencyContactState2 =
            key.emergencyContactState2;
        } else {
        ...
        if (key.emergencyContactStreetAddress1 != undefined) {
          employeeProfileJSON.emergencyContactStreetAddress1 =
            key.emergencyContactStreetAddress1;
        } else {
        ...
        if (key.emergencyContactStreetAddress2 != undefined) {
          employeeProfileJSON.emergencyContactStreetAddress2 =
            key.emergencyContactStreetAddress2;
        } else {
        ...
        if (key.emergencyContactWorkPhone1 != undefined) {
          employeeProfileJSON.emergencyContactWorkPhone1 =
            key.emergencyContactWorkPhone1;
        } else {
          employeeProfileJSON.emergencyContactWorkPhone1 = ''; //key.emergencyContactWorkPhone1;
        }

        if (key.emergencyContactWorkPhone2 != undefined) {
          employeeProfileJSON.emergencyContactWorkPhone2 =
            key.emergencyContactWorkPhone2;
        } else {
        ...
        if (key.training != undefined) {
          ...
          $.each(key.training, function(key, value) {
            if (value.dateOfTraining != undefined) {
              JSONtraining.dateOfTraining = getCorrectDateFormat(
    ...
    if (timeTableArr.length > 0) {
      $.each(timeTableArr, function(index, value) {
        ...
        if (value.tableDateVerified != null && value.tableDateVerified != '') {
          expenseDetailsElement.dateVerified = getCorrectDateFormat(
            value.tableDateVerified
          );
        } else {
        ...
        $.ajax({
          ...
          success: function(json) {
            ...
            expenseDetailsElement.jobCode.overrideCode = parseInt(
              json.overrideCode
            );
  ...
  try {
    ...
    $('#travelTable tr').each(function() {
      ...
      var table_hours = $(this)
        ...
        .html();
      var table_jobCodeDesc = $(this)
        .find('#ttableJobCodeDesc')
        .html();
      var table_Amount = $(this)
        .find('#ttableAmount')
        .html();
      var table_dateVerified = $(this)
        .find('#ttableDateVerified')
        .html();
    ...
    if (travelTableArr.length > 0) {
      $.each(travelTableArr, function(index, value) {
        ...
        if (
          value.ttableDateVerified != null &&
          value.ttableDateVerified != ''
        ) {
          expenseDetailsElement.dateVerified = getCorrectDateFormat(
            value.ttableDateVerified
          );
        ...
        $.ajax({
          ...
          success: function(json) {
            ...
            expenseDetailsElement.jobCode.description = json.description;
            expenseDetailsElement.jobCode.financialYear = parseInt(
              json.financialYear
            );
            expenseDetailsElement.jobCode.jobCode = json.jobCode;
...
$('#visaSubmit').click(function() {
  try {
    ...
    $('#visaTable tr').each(function() {
      ...
      var table_jobCodeDesc = $(this)
        .find('#vtableJobCodeDesc')
        .html();
      var table_Amount = $(this)
        .find('#vtableAmount')
        .html();
      var table_dateVerified = $(this)
        .find('#vtableDateVerified')
        .html();
    ...
    if (visaTableArr.length > 0) {
      $.each(visaTableArr, function(index, value) {
        ...
        if (
          value.vtableDateVerified != null &&
          value.vtableDateVerified != ''
        ) {
          expenseDetailsElement.dateVerified = getCorrectDateFormat(
            value.vtableDateVerified
          );
...
$('#otherSubmit').click(function() {
  try {
    ...
    $('#otherTable tr').each(function() {
      ...
      //var table_hours = $(this).find("#tableHours").html();
      var table_jobCodeDesc = $(this)
        .find('#otableJobCodeDesc')
        .html();
      var table_Amount = $(this)
        .find('#otableAmount')
        .html();
      var table_dateVerified = $(this)
        .find('o#tableDateVerified')
        .html();
    ...
    if (otherTableArr.length > 0) {
      $.each(otherTableArr, function(index, value) {
        ...
        if (
          value.otableDateVerified != null &&
          value.otableDateVerified != ''
        ) {
          expenseDetailsElement.dateVerified = getCorrectDateFormat(
            value.otableDateVerified
          );
