    ...
    <main id="main-content">
        <div class="wrapper">
            ...
            <section class="usa-section1">
					<div class="mainAdd" style="margin-left: 15px; margin-right: 15px">
							...
							<p class="contactClass">Employee Identification Information</p> 
							<div class="row">
								<div class="col">
									<div class="form-group">
							...
							<div class="row">
								<div class="col">
									<div class="form-group">
										<label class="control-label">other Identification Features:</label><textarea id="otherID" class="form-control"></textarea>
									</div>
								</div>
							</div>
